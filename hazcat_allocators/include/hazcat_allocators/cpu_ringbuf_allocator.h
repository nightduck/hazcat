...
#ifndef HAZCAT__ALLOCATORS__CPU_RINGBUF_ALLOCATOR_H_
#define HAZCAT__ALLOCATORS__CPU_RINGBUF_ALLOCATOR_H_
...
#endif  // HAZCAT__ALLOCATORS__CPU_RINGBUF_ALLOCATOR_H_
