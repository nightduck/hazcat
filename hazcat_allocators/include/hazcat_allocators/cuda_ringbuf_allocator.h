...
#ifndef HAZCAT__ALLOCATORS__CUDA_RINGBUF_ALLOCATOR_H_
#define HAZCAT__ALLOCATORS__CUDA_RINGBUF_ALLOCATOR_H_
...
#endif  // HAZCAT__ALLOCATORS__CUDA_RINGBUF_ALLOCATOR_H_
