...
#ifndef HAZCAT__ALLOCATORS__HMA_TEMPLATE_H_
#define HAZCAT__ALLOCATORS__HMA_TEMPLATE_H_
...
#define GET_PTR(alloc, offset, type) \
  (type *)((uint8_t *)alloc + (unsigned int)offset)
...
#endif  // HAZCAT__ALLOCATORS__HMA_TEMPLATE_H_
